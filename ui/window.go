...
func (pw *Visualizer) drawDefaultUI() {
	...
	pw.w.Fill(image.Rect(x-200, y+100, x+200, y-100), color.RGBA{R: 255, G: 255, B: 0, A: 255}, draw.Src)
	pw.w.Fill(image.Rect(x-100, y-200, x+100, y+200), color.RGBA{R: 255, G: 255, B: 0, A: 255}, draw.Src)
	// Малювання білої рамки.
	for _, br := range imageutil.Border(pw.sz.Bounds(), 3) {
		pw.w.Fill(br, color.Black, draw.Src)
	}
}
